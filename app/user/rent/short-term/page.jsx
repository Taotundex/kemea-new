    ...
    <div className='home'>
      {/* <div className="container"> */}
        <main className="font-primary text-text-color">
            {/* <Header /> */}
            <div className="mt-8 flex flex-col space-y-2 container">
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2">
                  <div className="card">
                    <div className="upper-img relative">
                      <Link href='/rent/short-term/description' className="img">
                    ...
                    <div className="details py-3">
                      ...
                      <h2 className='text-lg font-bold text-[#191C1F]'>From 2 300 ₪ / night </h2>
